...
extension SunnyDay {
    static var howToTitle = "SUNNY DAY"
    static var howToText = """
                        Sunny Day is a dynamic slot game set under the bright and cheerful theme of a sunny day. The game features a unouin g ehyers to make stratogle deettions to matinize
                        their winnings.
                        ...
                        How to play:
                            ...
                            3. After the spin, you can see if any elements for the special sun symbol) have appeared.
                        Decisions Post-Spin:
                            1. Spin N: If key symbols appear, you have the option to spin the same reel again to try and gather more key symbols, increasing your potential multiplier.
                            2. Go N+1: If you are satisfied with the symbols or want to minimize risks, press 'Go' to proceed to the next reel.
                        Accumulating Multipliers: Each reel has a defined multiplier step that increases based on the key symbols collected:
                            • first Reel: x0.25 per key element.
                            • Second Reel: ×0.5 per key element.
...
extension Thunderstorm {
    static var howToTitle = "Thunderstorm"
    static var howToText = """
                        A timing-based game where you must claim your winnings before a lightning strike ends the round.
                        The longer you wait, the higher the multiplier, but risk grows!
...
extension SnowMountains {
    static var howToTitle = "Snow Mountains"
    static var howToText = """
